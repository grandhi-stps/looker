view: map_views {
  derived_table: {
    sql: with
      ...
      ,cast(substring(a.location,1,(POSITION(',' IN a.location)-1)) as character varying) "Latitude"
      ,cast(substring(a.location,(POSITION(',' IN a.location)+1)) as character varying) "Longitude"
      ,sum(b.cnt)
      from a,b
